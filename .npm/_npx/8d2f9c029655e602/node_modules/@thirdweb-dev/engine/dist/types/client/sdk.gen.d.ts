...
import type { CreateAccountData, EncodeFunctionDataData, GetNativeBalanceData, GetTransactionAnalyticsData, GetTransactionAnalyticsSummaryData, ListAccountsData, ReadContractData, SearchTransactionsData, SendTransactionData, SendTransactionResponse, SignMessageData, SignTransactionData, SignTypedDataData, WriteContractData, WriteContractResponse } from "./types.gen.js";
 ...
 */
export declare const listAccounts: <ThrowOnError extends boolean = false>(options?: Options<ListAccountsData, ThrowOnError>) => import("@hey-api/client-fetch").RequestResult<{
    result: Array<{
        address: string;
 ...
 */
export declare const createAccount: <ThrowOnError extends boolean = false>(options?: Options<CreateAccountData, ThrowOnError>) => import("@hey-api/client-fetch").RequestResult<{
    result: {
        address: string;
        smartAccountAddress?: string;
    };
