...
export type WriteContractData = {
    body?: {
         ...
         */
        executionOptions: AutoExecutionOptions | AaExecutionOptions | AaZksyncExecutionOptions | EoaExecutionOptions;
        params: Array<{
            /**
...
export type WriteContractResponse = WriteContractResponses[keyof WriteContractResponses];
...
export type SignTransactionResponse = SignTransactionResponses[keyof SignTransactionResponses];
...
export type ReadContractResponse = ReadContractResponses[keyof ReadContractResponses];
...
export type EncodeFunctionDataResponse = EncodeFunctionDataResponses[keyof EncodeFunctionDataResponses];
