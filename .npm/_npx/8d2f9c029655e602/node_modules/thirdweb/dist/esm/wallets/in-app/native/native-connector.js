...
export class InAppNativeConnector {
    ...
    async initializeWallet(authResult, encryptionKey) {
        ...
        const { getUserStatus } = await import("../core/actions/get-enclave-user-status.js");
        ...
        if (authResult && wallet && wallet.type === "sharded") {
            try {
                const { migrateToEnclaveWallet } = await import("./helpers/wallet/migration.js");
        ...
        if (authResult && !wallet) {
            ...
            const { generateWallet } = await import("../core/actions/generate-wallet.enclave.js");
        ...
        if (wallet && wallet.type === "enclave") {
            const { EnclaveWallet } = await import("../core/wallet/enclave-wallet.js");
            ...
            const { ShardedWallet } = await import("./helpers/wallet/sharded-wallet.js");
    ...
    async authenticate(params) {
        ...
        switch (strategy) {
            ...
            case "guest": {
                const { guestAuthenticate } = await import("../core/authentication/guest.js");
            ...
            case "backend": {
                const { backendAuthenticate } = await import("../core/authentication/backend.js");
            ...
            case "wallet": {
                const { siweAuthenticate } = await import("../core/authentication/siwe.js");
            ...
            case "auth_endpoint": {
                const { authEndpoint } = await import("../core/authentication/authEndpoint.js");
                return authEndpoint({
                    client: this.client,
                    ecosystem: this.ecosystem,
    ...
    async passkeyAuth(args) {
        ...
        try {
            ...
            let authToken;
            if (type === "sign-up") {
                const { registerPasskey } = await import("../core/authentication/passkeys.js");
                ...
                const { loginWithPasskey } = await import("../core/authentication/passkeys.js");
    ...
    async linkProfile(args) {
        const { linkAccount } = await import("../core/authentication/linkAccount.js");
    ...
    async unlinkProfile(profile, allowAccountDeletion) {
        const { unlinkAccount } = await import("../core/authentication/linkAccount.js");
    ...
    async getProfiles() {
        const { getLinkedProfilesInternal } = await import("../core/authentication/linkAccount.js");
