...
export function DetailsModal(props) {
    ...
    let content = (_jsxs("div", { className: `${TW_CONNECTED_WALLET}__default_modal_screen`, children: [_jsx(Spacer, { y: "xs" }), _jsxs(Container, { center: "y", flex: "row", gap: "sm", px: "lg", style: {
                    ...
                    paddingTop: spacing.lg,
                                ...
                                gap: spacing.xs,
                                        ...
                                        gap: spacing.xs,
                                        padding: spacing.sm,
                                    }, variant: "outline", children: [_jsx(Container, { center: "both", color: "secondaryText", flex: "row", children: _jsx(PinBottomIcon, { height: iconSize.sm, width: iconSize.sm }) }), locale.receive] })), !hideBuyFunds && (_jsxs(Button, { onClick: () => {
                                        trackPayEvent({
                                            client: client,
    ...
    // thirdweb pay
        ...
        content = (_jsx(LazyBuyScreen, { client: client, connectLocale: locale, connectOptions: undefined, hiddenWallets: props.detailsModal?.hiddenWallets, isEmbed: false, onBack: () => setScreen("main"), onDone: closeModal, payOptions: props.detailsModal?.payOptions || {
                mode: "fund_wallet",
