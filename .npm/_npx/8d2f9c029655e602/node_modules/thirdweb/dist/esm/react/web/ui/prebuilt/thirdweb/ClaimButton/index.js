...
export async function getERC721ClaimTo({ contract, account, claimParams, }) {
    const { claimTo } = await import("../../../../../../extensions/erc721/drops/write/claimTo.js");
    return claimTo({
        contract,
...
export async function getERC1155ClaimTo({ contract, account, claimParams, }) {
    const { claimTo } = await import("../../../../../../extensions/erc1155/drops/write/claimTo.js");
    return claimTo({
        contract,
        from: claimParams.from,
        quantity: claimParams.quantity,
...
export async function getERC20ClaimTo({ contract, account, claimParams, }) {
    ...
    const { claimTo } = await import("../../../../../../extensions/erc20/drops/write/claimTo.js");
