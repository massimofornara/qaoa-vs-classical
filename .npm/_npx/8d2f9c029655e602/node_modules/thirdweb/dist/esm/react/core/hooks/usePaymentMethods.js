...
export function usePaymentMethods(options) {
    ...
    const routesQuery = useQuery({
        ...
        queryFn: async () => {
            ...
            owned.sort((a, b) => {
                const aDollarBalance = Number.parseFloat(toTokens(a.balance, a.originToken.decimals)) *
                    a.originToken.priceUsd;
                const bDollarBalance = Number.parseFloat(toTokens(b.balance, b.originToken.decimals)) *
            ...
            for (const b of owned) {
                if (b.originToken && b.balance > 0n) {
                    const dollarBalance = Number.parseFloat(toTokens(b.balance, b.originToken.decimals)) *
                        b.originToken.priceUsd;
