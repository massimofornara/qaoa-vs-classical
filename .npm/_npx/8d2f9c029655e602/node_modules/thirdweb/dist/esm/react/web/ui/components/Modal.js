...
export const Modal = (props) => {
    ...
    return (_jsxs(Dialog.Root, { open: open, onOpenChange: props.setOpen, children: [props.trigger && (_jsx(Dialog.Trigger, { asChild: true, children: props.trigger })), _jsxs(Dialog.Portal, { children: [!props.hide && (_jsx(Dialog.Overlay, { asChild: true, children: _jsx(Overlay, { ref: overlayRef }) })), _jsx(FocusScope, { trapped: !props.hide, children: _jsx(Dialog.Content, { asChild: true, "aria-describedby": undefined, children: _jsxs(DialogContent, { ref: contentRef, style: props.hide
                                    ...
                                    : {
                                        ...
                                        maxWidth: props.size === "compact"
                                            ...
                                            whiteSpace: "nowrap",
                                            borderWidth: 0,
                                        }, children: "Connect Modal" }), props.size === "compact" ? (_jsx(DynamicHeight, { maxHeight: compactModalMaxHeight, children: props.children })) : (props.children), !props.hideCloseIcon && (_jsx(CrossContainer, { children: _jsx(Dialog.Close, { asChild: true, children: _jsx(IconButton, { autoFocus: true, type: "button", "aria-label": "Close", children: _jsx(Cross2Icon, { width: iconSize.md, height: iconSize.md, style: {
                                                        color: "inherit",
                                                    } }) }) }) }))] }) }) })] })] }));
};
