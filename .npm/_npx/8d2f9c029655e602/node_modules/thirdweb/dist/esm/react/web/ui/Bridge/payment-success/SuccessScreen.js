...
export function SuccessScreen({ uiOptions, preparedQuote, completedStatuses, onDone, windowAdapter, }) {
    ...
    return (_jsxs(Container, { flex: "column", fullHeight: true, p: "lg", children: [_jsx(ModalHeader, { title: "Payment Complete" }), _jsx(Spacer, { y: "xl" }), _jsxs(Container, { center: "x", flex: "column", gap: "md", children: [_jsx(Container, { center: "both", flex: "row", style: {
                            ...
                            }, width: iconSize.xl }) }), _jsx(Text, { center: true, color: "primaryText", size: "xl", children: "Payment Successful!" }), _jsx(Text, { center: true, color: "secondaryText", size: "sm", children: "Your cross-chain payment has been completed successfully." })] }), _jsx(Spacer, { y: "lg" }), _jsxs(Container, { flex: "column", gap: "sm", style: { width: "100%" }, children: [_jsx(Button, { fullWidth: true, onClick: () => setViewState("detail"), variant: "secondary", children: "View Payment Receipt" }), _jsx(Button, { fullWidth: true, onClick: onDone, variant: "accent", children: uiOptions.mode === "transaction" ? "Continue" : "Done" })] }), _jsx("style", { children: `
