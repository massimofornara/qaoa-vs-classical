...
export function FiatProviderSelection({ onProviderSelected, client, toChainId, toTokenAddress, toAddress, toAmount, }) {
    ...
    return (_jsx(_Fragment, { children: _jsx(Container, { flex: "column", gap: "sm", children: quotes.length > 0 ? (quotes
                ...
                return (_jsx(Container, { animate: "fadein", style: {
                        animationDelay: `${index * 100}ms`,
                            ...
                            textAlign: "left",
                                    ...
                                    }, children: _jsx(Img, { alt: provider.name, client: client, height: iconSize.md, src: provider.iconUri, width: iconSize.md }) }), _jsx(Container, { flex: "column", gap: "3xs", style: { flex: 1 }, children: _jsx(Text, { color: "primaryText", size: "md", style: { fontWeight: 600 }, children: provider.name }) }), _jsxs(Container, { flex: "column", gap: "3xs", style: { alignItems: "flex-end" }, children: [_jsxs(Text, { color: "primaryText", size: "sm", style: { fontWeight: 500 }, children: ["$", quote.currencyAmount.toLocaleString(undefined, {
                                                    maximumFractionDigits: 2,
                                                    minimumFractionDigits: 2,
                                                }), " ", quote.currency] }), _jsxs(Text, { color: "secondaryText", size: "xs", children: [toTokens(quote.destinationAmount, quote.destinationToken.decimals), " ", quote.destinationToken.symbol] })] })] }) }) }, provider.id));
