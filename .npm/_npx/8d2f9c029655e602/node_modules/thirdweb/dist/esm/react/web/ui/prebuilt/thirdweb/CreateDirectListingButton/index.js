...
export function CreateDirectListingButton(props) {
    ...
    const prepareTransaction = useCallback(async () => {
        ...
        if (is1155) {
            const [{ isApprovedForAll }, { setApprovalForAll }] = await Promise.all([
                import("../../../../../../extensions/erc1155/__generated__/IERC1155/read/isApprovedForAll.js"),
                import("../../../../../../extensions/erc1155/__generated__/IERC1155/write/setApprovalForAll.js"),
            ]);
            ...
            const [{ isApprovedForAll }, { setApprovalForAll }, { getApproved }] = await Promise.all([
                import("../../../../../../extensions/erc721/__generated__/IERC721A/read/isApprovedForAll.js"),
                import("../../../../../../extensions/erc721/__generated__/IERC721A/write/setApprovalForAll.js"),
                import("../../../../../../extensions/erc721/__generated__/IERC721A/read/getApproved.js"),
            ]);
    ...
    return (_jsx(TransactionButton, { payModal: {
            metadata: defaultPayModalMetadata || payMetadata,
            ...payModal,
        }, transaction: () => prepareTransaction(), ...props, children: children }));
}
/**
 * @internal
 */
