...
import { APPLE_ICON, DISCORD_ICON, EMAIL_ICON, FACEBOOK_ICON, FARCASTER_ICON, GITHUB_ICON, GOOGLE_ICON, GUEST_ICON, LINE_ICON, PASSKEY_ICON, PHONE_ICON, STEAM_ICON, TELEGRAM_ICON, TWITCH_ICON, WALLET_ICON, X_ICON, } from "../icons/svgs.js";
...
export const WalletImage = (props) => {
    ...
    return (_jsx(RNImage, { color: props.theme.colors.accentButtonBg, data: data, size: size, theme: props.theme }));
};
