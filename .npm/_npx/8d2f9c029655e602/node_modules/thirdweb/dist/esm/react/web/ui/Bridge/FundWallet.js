...
export function FundWallet({ client, receiverAddress, uiOptions, onContinue, presetOptions = [5, 10, 20], connectOptions, }) {
    ...
    return (_jsxs(WithHeader, { client: client, defaultTitle: `Buy ${uiOptions.destinationToken.symbol}`, uiOptions: uiOptions, children: [_jsxs(Container, { flex: "column", children: [_jsxs(Container, { center: "both", flex: "row", gap: "3xs", p: "md", style: {
                                    ...
                                    justifyContent: "flex-end",
                                        ...
                                        role: "button", style: { cursor: "text" }, tabIndex: 0, children: _jsx(Container, { center: "y", flex: "row", gap: "xs", style: {
                                                ...
                                                justifyContent: "flex-end",
                                                    ...
                                                    padding: "0",
                                                    textAlign: "right",
                                                }, type: "text", value: amount || "0", variant: "transparent" }) }) }), _jsx(Container, { center: "both", flex: "row", style: { flexWrap: "nowrap", height: fontSize.lg }, children: _jsxs(Text, { color: "secondaryText", size: "md", style: { textWrap: "nowrap" }, children: ["\u2248 $", (Number(amount) * uiOptions.destinationToken.priceUsd).toFixed(2)] }) })] })] }), presetOptions && (_jsxs(_Fragment, { children: [_jsx(Spacer, { y: "md" }), _jsx(Container, { center: "x", flex: "row", gap: "xs", style: {
                            ...
                            borderRadius: radius.md,
                                        ...
                                        flex: 1,
                                    }, children: "No Wallet Connected" })] })) })] }), _jsx(Spacer, { y: "lg" }), receiver ? (_jsxs(Button, { disabled: !isValidAmount, fullWidth: true, onClick: () => {
                    if (isValidAmount) {
                    ...
                    padding: `${spacing.sm} ${spacing.md}`,
                }, variant: "primary", children: ["Buy ", amount, " ", uiOptions.destinationToken.symbol] })) : (_jsx(ConnectButton, { client: client, connectButton: {
