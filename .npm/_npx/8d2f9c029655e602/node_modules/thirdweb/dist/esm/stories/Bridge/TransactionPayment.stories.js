...
const TransactionPaymentWithTheme = (props) => {
    ...
    return (_jsx(ModalThemeWrapper, { theme: theme, children: _jsx("div", { style: { width: "400px" }, children: _jsx(TransactionPayment, { ...componentProps }) }) }));
};
const meta = {
    args: {
        client: storyClient,
...
export const EthereumTransferLight = {
    args: {
        theme: "light",
        uiOptions: TRANSACTION_UI_OPTIONS.ethTransfer,
    },
...
export const ERC20TokenTransferLight = {
    args: {
        theme: "light",
        uiOptions: TRANSACTION_UI_OPTIONS.erc20Transfer,
    },
...
export const ContractInteractionLight = {
    args: {
        theme: "light",
        uiOptions: TRANSACTION_UI_OPTIONS.contractInteraction,
    },
