...
import { DirectPayment, } from "../../react/web/ui/Bridge/DirectPayment.js";
import { ModalThemeWrapper, storyClient } from "../utils.js";
import { DIRECT_PAYMENT_UI_OPTIONS } from "./fixtures.js";
// Wrapper component to provide theme context
const DirectPaymentWithTheme = (props) => {
    const { theme, ...componentProps } = props;
    return (_jsx(ModalThemeWrapper, { theme: theme, children: _jsx(DirectPayment, { ...componentProps }) }));
};
const meta = {
    args: {
        client: storyClient,
...
export const ConcertTicketLight = {
    args: {
        theme: "light",
        uiOptions: DIRECT_PAYMENT_UI_OPTIONS.concertTicket,
    },
...
export const SubscriptionServiceLight = {
    args: {
        theme: "light",
        uiOptions: DIRECT_PAYMENT_UI_OPTIONS.subscription,
    },
...
export const PhysicalProductLight = {
    args: {
        theme: "light",
        uiOptions: DIRECT_PAYMENT_UI_OPTIONS.sneakers,
    },
