...
export declare function QuoteLoader({ destinationToken, paymentMethod, amount, sender, receiver, client, onQuoteReceived, onError, purchaseData, paymentLinkId, feePayer, }: QuoteLoaderProps): import("react/jsx-runtime").JSX.Element;
export {};
