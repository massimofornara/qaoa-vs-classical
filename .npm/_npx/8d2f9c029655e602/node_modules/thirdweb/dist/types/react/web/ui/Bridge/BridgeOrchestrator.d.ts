...
export declare function BridgeOrchestrator({ client, uiOptions, receiverAddress, onComplete, onError, onCancel, connectOptions, connectLocale, purchaseData, paymentLinkId, presetOptions, }: BridgeOrchestratorProps): import("react/jsx-runtime").JSX.Element;
