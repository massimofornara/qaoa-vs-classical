...
import type { ConnectButton_connectModalOptions, ConnectButton_detailsButtonOptions, ConnectButton_detailsModalOptions, ConnectButtonProps, PayUIOptions } from "../../../core/hooks/connection/ConnectButtonProps.js";
...
import { type AssetTabs } from "./screens/ViewAssets.js";
/**
 * @internal
 */
 ...
 */
export declare function detailsBtn_formatFiatBalanceForButton(props: AccountBalanceInfo): string;
/**
 * @internal Exported for test
 */
export declare function detailsBtn_formatTokenBalanceForButton(props: AccountBalanceInfo): string;
/**
 * @internal Exported for tests only
 */
export declare function DetailsModal(props: {
    client: ThirdwebClient;
 ...
 * @internal
 */
export declare function NetworkSwitcherButton(props: {
 ...
 */
export declare const StyledChevronRightIcon: import("@emotion/styled").StyledComponent<import("@radix-ui/react-icons/dist/types.js").IconProps & import("react").RefAttributes<SVGSVGElement> & {
    theme?: import("@emotion/react").Theme;
}, {}, {}>;
/**
 * @internal Exported for test
 */
export declare function ConnectedToSmartWallet(props: {
    client: ThirdwebClient;
    connectLocale: ConnectLocale;
}): import("react/jsx-runtime").JSX.Element | null;
/**
 * @internal Exported for tests
 */
export declare function InAppWalletUserInfo(props: {
    client: ThirdwebClient;
    locale: ConnectLocale;
}): import("react/jsx-runtime").JSX.Element;
/**
 * @internal Exported for tests
 */
export declare function SwitchNetworkButton(props: {
