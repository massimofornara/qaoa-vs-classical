import type { AbiParameter, AbiParametersToPrimitiveTypes, AbiParameterToPrimitiveType } from "abitype";
 ...
 */
export declare function prepareParam<const TParam extends AbiParameter>({ param, value, }: {
    param: TParam;
 ...
 * @internal Export for unit test
 */
export declare function encodeAddress(value: Hex): PreparedParam;
export {};
