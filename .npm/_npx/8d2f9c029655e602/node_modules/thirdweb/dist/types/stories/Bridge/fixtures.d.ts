...
export declare const UNI: Token;
...
export declare const FUND_WALLET_UI_OPTIONS: Record<"ethDefault" | "ethWithAmount" | "usdcDefault" | "uniLarge", FundWalletUIOptions>;
export declare const DIRECT_PAYMENT_UI_OPTIONS: Record<"digitalArt" | "concertTicket" | "subscription" | "sneakers" | "credits", DirectPaymentUIOptions>;
export declare const TRANSACTION_UI_OPTIONS: Record<"ethTransfer" | "erc20Transfer" | "contractInteraction", TransactionUIOptions>;
export {};
