...
exports.CUSTOM_CHAIN_MAP = void 0;
...
exports.convertLegacyChain = convertLegacyChain;
exports.convertViemChain = convertViemChain;
...
exports.getChainServices = getChainServices;
 ...
 */
exports.CUSTOM_CHAIN_MAP = new Map();
/**
...
function defineChain(options) {
    ...
    exports.CUSTOM_CHAIN_MAP.set(options.id, chain);
    return chain;
}
/**
 * @internal
...
function cacheChains(chains) {
    for (const chain of chains) {
        exports.CUSTOM_CHAIN_MAP.set(chain.id, chain);
    }
}
/**
 * @internal
...
function getCachedChain(id) {
    if (exports.CUSTOM_CHAIN_MAP.has(id)) {
        return exports.CUSTOM_CHAIN_MAP.get(id);
    }
    const RPC_URL = (0, domains_js_1.getThirdwebDomains)().rpc;
    const chain = {
        id: id,
