...
const RNImage = (props) => {
    ...
    switch (type) {
        case "url":
        case "image":
            return ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(react_native_1.Image, { height: size, loadingIndicatorSource: { uri: placeholder }, source: { uri: image }, style: [{ borderRadius: index_js_1.radius.md }], width: size }) }));
        case "xml":
            return (0, jsx_runtime_1.jsx)(react_native_svg_1.SvgXml, { color: color, height: size, width: size, xml: image });
        default:
            return null;
    }
};
