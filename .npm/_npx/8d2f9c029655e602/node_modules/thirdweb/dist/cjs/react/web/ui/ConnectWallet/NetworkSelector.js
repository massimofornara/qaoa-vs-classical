...
exports.StyledMagnifyingGlassIcon = exports.NetworkButton = exports.SectionLabel = exports.TabButton = exports.ChainButton = exports.NetworkList = void 0;
...
const name_js_1 = require("../prebuilt/Chain/name.js");
const provider_js_1 = require("../prebuilt/Chain/provider.js");
...
function NetworkSelectorContent(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { children: [(0, jsx_runtime_1.jsx)(basic_js_1.Container, { p: "lg", children: props.onBack ? ((0, jsx_runtime_1.jsx)(basic_js_1.ModalHeader, { onBack: props.onBack, title: locale.title })) : ((0, jsx_runtime_1.jsx)(modalElements_js_1.ModalTitle, { children: locale.title })) }), props.showTabs !== false && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(basic_js_1.Container, { px: "lg", children: (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "row", gap: "xxs", children: [(0, jsx_runtime_1.jsx)(exports.TabButton, { "data-active": selectedTab === "all", onClick: () => setSelectedTab("all"), children: locale.allNetworks }), (0, jsx_runtime_1.jsx)(exports.TabButton, { "data-active": selectedTab === "mainnet", onClick: () => setSelectedTab("mainnet"), children: locale.mainnets }), (0, jsx_runtime_1.jsx)(exports.TabButton, { "data-active": selectedTab === "testnet", onClick: () => setSelectedTab("testnet"), children: locale.testnets })] }) }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "lg" })] })), props.showTabs === false && (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "xxs" }), (0, jsx_runtime_1.jsx)(basic_js_1.Container, { px: "lg", children: (0, jsx_runtime_1.jsxs)("div", { style: {
                        alignItems: "center",
                        display: "flex",
                        position: "relative",
                    }, children: [(0, jsx_runtime_1.jsx)(exports.StyledMagnifyingGlassIcon, { height: index_js_1.iconSize.md, width: index_js_1.iconSize.md }), (0, jsx_runtime_1.jsx)(formElements_js_1.Input, { disabled: isAllChainsQueryLoading, onChange: (e) => {
                            ...
                            }, tabIndex: -1, value: searchTerm, variant: "outline" }), (deferredSearchTerm !== searchTerm || isAllChainsQueryLoading) && ((0, jsx_runtime_1.jsx)("div", { style: {
                                position: "absolute",
                                right: index_js_1.spacing.md,
                            }, children: (0, jsx_runtime_1.jsx)(Spinner_js_1.Spinner, { color: "accentText", size: "md" }) }))] }) }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "lg" }), (0, jsx_runtime_1.jsx)(basic_js_1.Container, { px: "md", children: (0, jsx_runtime_1.jsx)(NetworkTabContent, { chainSections: filteredChainSections, client: props.client, close: props.closeModal, connectLocale: props.connectLocale, onSwitch: handleSwitch, renderChain: props.networkSelector?.renderChain }) }), onCustomClick && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(basic_js_1.Line, {}), (0, jsx_runtime_1.jsx)(basic_js_1.Container, { p: "lg", children: (0, jsx_runtime_1.jsx)(buttons_js_1.Button, { fullWidth: true, onClick: () => {
                                onCustomClick();
                                props.closeModal();
                            }, style: {
                                boxShadow: "none",
...
const NetworkTabContent = (props) => {
    ...
    return ((0, jsx_runtime_1.jsx)(basic_js_1.Container, { animate: "fadein", scrollY: true, style: {
            height: "330px",
            paddingBottom: index_js_1.spacing.lg,
        }, children: noChainsToShow ? ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { center: "both", color: "secondaryText", flex: "column", gap: "md", children: [(0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "xl" }), (0, jsx_runtime_1.jsx)(react_icons_1.CrossCircledIcon, { height: index_js_1.iconSize.xl, width: index_js_1.iconSize.xl }), (0, jsx_runtime_1.jsx)(text_js_1.Text, { children: " No Results " })] })) : (chainSections.map((section, idx) => {
            if (section.chains.length === 0) {
                return null;
            }
            return ((0, jsx_runtime_1.jsxs)(react_1.Fragment, { children: [idx !== 0 && (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "lg" }), (0, jsx_runtime_1.jsx)(exports.SectionLabel, { children: section.label }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "xs" }), (0, jsx_runtime_1.jsx)(exports.NetworkList, { chains: section.chains, client: props.client, close: props.close, connectLocale: props.connectLocale, onSwitch: props.onSwitch, renderChain: props.renderChain })] }, section.label));
        })) }));
};
/**
 * @internal Exported for tests
 */
exports.NetworkList = (0, react_1.memo)(function NetworkList(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(NetworkListUl, { children: chainsToShow.map((chain, i) => {
            ...
            return ((0, jsx_runtime_1.jsx)("li", { ref: isLast ? lastItemRef : undefined, children: RenderChain ? ((0, jsx_runtime_1.jsx)(RenderChain, { chain: chain, close: props.close, switchChain: () => {
                        handleSwitch(chain);
                    }, switchFailed: errorSwitchingChainId === chain.id, switching: switchingChainId === chain.id })) : ((0, jsx_runtime_1.jsx)(exports.ChainButton, { chain: chain, client: props.client, confirming: confirming, connectLocale: props.connectLocale, onClick: () => handleSwitch(chain), switchingFailed: switchingFailed })) }, chain.id));
        }) }));
});
/**
 * @internal
...
exports.ChainButton = (0, react_1.memo)(function ChainButton(props) {
    ...
    const activeChain = (0, useActiveWalletChain_js_1.useActiveWalletChain)();
    return ((0, jsx_runtime_1.jsx)(provider_js_1.ChainProvider, { chain: chain, children: (0, jsx_runtime_1.jsxs)(exports.NetworkButton, { "data-active": activeChain?.id === chain.id, onClick: props.onClick, children: [(0, jsx_runtime_1.jsxs)(basic_js_1.Container, { style: {
                        alignItems: "center",
                        display: "flex",
                        flexShrink: 0,
                        position: "relative",
                    }, children: [(0, jsx_runtime_1.jsx)(icon_js_1.ChainIcon, { client: props.client, fallbackComponent: (0, jsx_runtime_1.jsx)("img", { alt: "", src: fallbackChainIcon_js_1.fallbackChainIcon, style: {
                                    height: `${index_js_1.iconSize.lg}px`,
                                    width: `${index_js_1.iconSize.lg}px`,
                                } }), loading: "lazy", loadingComponent: (0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { height: `${index_js_1.iconSize.lg}px`, width: `${index_js_1.iconSize.lg}px` }), style: {
                                height: `${index_js_1.iconSize.lg}px`,
                                width: `${index_js_1.iconSize.lg}px`,
                            } }), activeChain?.id === chain.id && ((0, jsx_runtime_1.jsx)(ChainActiveDot_js_1.ChainActiveDot, { className: "tw-chain-active-dot-button-network-selector" }))] }), confirming || switchingFailed ? ((0, jsx_runtime_1.jsxs)("div", { style: {
                        display: "flex",
                        flexDirection: "column",
                        gap: index_js_1.spacing.xs,
                    }, children: [(0, jsx_runtime_1.jsx)(name_js_1.ChainName, { loadingComponent: (0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { height: "20px", width: "150px" }) }), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { animate: "fadein", center: "y", flex: "row", gap: "xxs", children: [confirming && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "accentText", size: "xs", children: locale.switchingNetwork }), (0, jsx_runtime_1.jsx)(Spinner_js_1.Spinner, { color: "accentText", size: "xs" })] })), switchingFailed && ((0, jsx_runtime_1.jsx)(basic_js_1.Container, { animate: "fadein", children: (0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "danger", size: "xs", children: locale.networkSelector.failedToSwitch }) }))] })] })) : ((0, jsx_runtime_1.jsx)(name_js_1.ChainName, { className: "tw-chain-icon-none-confirming", loadingComponent: (0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { height: "20px", width: "150px" }) }))] }) }));
});
/**
 * @internal Exported for tests
 */
exports.TabButton = (() => styled_1.default.button((_) => {
 ...
 * @internal Exported for tests
 */
exports.SectionLabel = (0, elements_js_1.StyledP)(() => {
    const theme = (0, CustomThemeProvider_js_1.useCustomTheme)();
    return {
        color: theme.colors.secondaryText,
        display: "block",
 ...
 * @internal Exported for tests
 */
exports.NetworkButton = (0, elements_js_1.StyledButton)((_) => {
    const theme = (0, CustomThemeProvider_js_1.useCustomTheme)();
    return {
        "&:hover": {
            background: theme.colors.secondaryButtonBg,
 ...
 * @internal Exported for tests
 */
exports.StyledMagnifyingGlassIcon = (0, styled_1.default)(react_icons_1.MagnifyingGlassIcon)((_) => {
    const theme = (0, CustomThemeProvider_js_1.useCustomTheme)();
    return {
        color: theme.colors.secondaryText,
...
function useNetworkSwitcherModal() {
    ...
    const openNetworkSwitcher = (0, react_1.useCallback)(async (props) => {
        ...
        setRootEl((0, jsx_runtime_1.jsx)(CustomThemeProvider_js_1.CustomThemeProvider, { theme: props.theme, children: (0, jsx_runtime_1.jsx)(Modal_js_1.Modal, { open: true, setOpen: (value) => {
                    if (!value) {
                        closeModal();
                    }
                }, size: "compact", style: {
                    paddingBottom: props.onCustomClick ? index_js_1.spacing.md : "0px",
                }, children: (0, jsx_runtime_1.jsx)(NetworkSelectorContent, { chains: [activeChain], client: props.client, closeModal: closeModal, connectLocale: locale, networkSelector: {
