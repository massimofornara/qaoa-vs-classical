...
function ConnectButton(props) {
    ...
    (0, useAutoConnect_js_1.useAutoConnect)({
        ...props,
        siweAuth: siweAuth,
    });
    ...
    return ((0, jsx_runtime_1.jsxs)(react_native_1.View, { children: [isConnectedAndAuth ? ((0, jsx_runtime_1.jsx)(ConnectedButton_js_1.ConnectedButton, { account: account, onClose: closeModal, openModal: () => openModal(), wallet: wallet, ...props })) : ((0, jsx_runtime_1.jsx)(button_js_1.ThemedButton, { onPress: () => openModal(), theme: theme, children: status === "connecting" ||
                    siweAuth.isLoggingIn ||
                    siweAuth.isLoading ||
                    siweAuth.isLoggingOut ? ((0, jsx_runtime_1.jsx)(spinner_js_1.ThemedSpinner, { color: theme.colors.primaryButtonText })) : ((0, jsx_runtime_1.jsx)(text_js_1.ThemedText, { style: { color: theme.colors.primaryButtonText }, theme: theme, type: "defaultSemiBold", children: isConnectedAndNotAuth
                        ? props.signInButton?.label || "Sign In"
                        : props.connectButton?.label || "Connect Wallet" })) })), (0, jsx_runtime_1.jsx)(react_native_1.Modal, { animationType: "none", onRequestClose: closeModal, transparent: true, visible: visible, children: (0, jsx_runtime_1.jsxs)(react_native_1.KeyboardAvoidingView, { behavior: "padding", style: { flex: 1 }, children: [(0, jsx_runtime_1.jsx)(react_native_1.Animated.View, { style: [styles.modalOverlay, { opacity: fadeAnim.current }] }), (0, jsx_runtime_1.jsxs)(react_native_1.Animated.View, { style: [
                                { flex: 1, transform: [{ translateY: slideAnim.current }] },
                            ], children: [(0, jsx_runtime_1.jsx)(react_native_1.Pressable, { onPress: closeModal, style: styles.dismissArea }), (0, jsx_runtime_1.jsx)(react_native_1.View, { style: styles.bottomSheetContainer, children: isConnectedAndAuth ? ((0, jsx_runtime_1.jsx)(ConnectedModal_js_1.ConnectedModal, { ...props, account: account, containerType: "modal", onClose: closeModal, theme: theme, wallet: wallet })) : ((0, jsx_runtime_1.jsx)(ConnectModal_js_1.ConnectModal, { ...props, containerType: "modal", onClose: closeModal, siweAuth: siweAuth, theme: theme })) })] })] }) })] }));
}
