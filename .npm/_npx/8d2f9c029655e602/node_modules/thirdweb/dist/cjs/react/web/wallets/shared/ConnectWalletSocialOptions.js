...
const ConnectWalletSocialOptions = (props) => {
    ...
    return ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "column", gap: "md", style: {
            position: "relative",
        }, children: [optionalImageMetadata && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(Img_js_1.Img, { alt: optionalImageMetadata.alt, client: props.client, height: `${optionalImageMetadata.height}`, src: optionalImageMetadata.src, style: { margin: "auto" }, width: `${optionalImageMetadata.width}` }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "xxs" })] })), hasSocialLogins && ((0, jsx_runtime_1.jsx)(basic_js_1.Container, { flex: "column", gap: socialLogins.length > 4 ? "xs" : "sm", children: socialLoginColumns.map((column) => ((0, jsx_runtime_1.jsx)(SocialButtonRow, { children: column.map((loginMethod) => {
                        const imgIconSize = (() => {
                            if (!showOnlyIcons) {
                        ...
                        return ((0, jsx_runtime_1.jsxs)(SocialButton, { "aria-label": `Login with ${loginMethod}`, "data-variant": showOnlyIcons ? "icon" : "full", disabled: props.disabled, onClick: () => {
                                handleSocialLogin(loginMethod);
                            }, style: {
                                flexGrow: socialLogins.length < 7 ? 1 : 0,
                            }, variant: "outline", children: [(0, jsx_runtime_1.jsx)(Img_js_1.Img, { client: props.client, height: imgIconSize, src: walletIcon_js_1.socialIcons[loginMethod], width: imgIconSize }), !showOnlyIcons &&
                ...
                (inputMode === "email" ? ((0, jsx_runtime_1.jsx)(InputSelectionUI_js_1.InputSelectionUI, { disabled: props.disabled, emptyErrorMessage: emptyErrorMessage, errorMessage: (input) => {
                        ...
                        props.select();
                    }, placeholder: placeholder, submitButtonText: locale.submitEmail, type: type })) : ((0, jsx_runtime_1.jsx)(WalletTypeRowButton_js_1.WalletTypeRowButton, { client: props.client, disabled: props.disabled, icon: EmailIcon_js_1.EmailIcon, onClick: () => {
                        setManualInputMode("email");
                    }, title: locale.emailPlaceholder }))), isPhoneEnabled &&
                (inputMode === "phone" ? ((0, jsx_runtime_1.jsx)(InputSelectionUI_js_1.InputSelectionUI, { allowedSmsCountryCodes: wallet.getConfig()?.auth?.allowedSmsCountryCodes, defaultSmsCountryCode: wallet.getConfig()?.auth?.defaultSmsCountryCode, disabled: props.disabled, emptyErrorMessage: emptyErrorMessage, errorMessage: (_input) => {
                        ...
                        props.select();
                    }, placeholder: placeholder, submitButtonText: locale.submitEmail, type: type })) : ((0, jsx_runtime_1.jsx)(WalletTypeRowButton_js_1.WalletTypeRowButton, { client: props.client, disabled: props.disabled, icon: PhoneIcon_js_1.PhoneIcon, onClick: () => {
                        setManualInputMode("phone");
                    }, title: locale.phonePlaceholder }))), passKeyEnabled && ((0, jsx_runtime_1.jsx)(WalletTypeRowButton_js_1.WalletTypeRowButton, { client: props.client, disabled: props.disabled, icon: FingerPrintIcon_js_1.FingerPrintIcon, onClick: () => {
                    handlePassKeyLogin();
                }, title: locale.passkey })), siweEnabled && !props.isLinking && ((0, jsx_runtime_1.jsx)(WalletTypeRowButton_js_1.WalletTypeRowButton, { client: props.client, icon: OutlineWalletIcon_js_1.OutlineWalletIcon, onClick: () => {
                    handleWalletLogin();
                }, title: locale.signInWithWallet })), guestEnabled && ((0, jsx_runtime_1.jsx)(WalletTypeRowButton_js_1.WalletTypeRowButton, { client: props.client, disabled: props.disabled, icon: GuestIcon_js_1.GuestIcon, onClick: () => {
                    handleGuestLogin();
                }, title: locale.loginAsGuest })), props.isLinking && ((0, jsx_runtime_1.jsx)(WalletTypeRowButton_js_1.WalletTypeRowButton, { client: props.client, icon: OutlineWalletIcon_js_1.OutlineWalletIcon, onClick: () => {
                    handleWalletLogin();
                }, title: locale.linkWallet }))] }));
};
exports.ConnectWalletSocialOptions = ConnectWalletSocialOptions;
const SocialButtonRow = (props) => ((0, jsx_runtime_1.jsx)(basic_js_1.Container, { center: "x", flex: "row", gap: props.children.length > 4 ? "xs" : "sm", style: {
        display: "flex",
