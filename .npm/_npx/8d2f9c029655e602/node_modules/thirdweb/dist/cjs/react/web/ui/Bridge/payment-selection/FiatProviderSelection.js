                ...
                return ((0, jsx_runtime_1.jsx)(basic_js_1.Container, { animate: "fadein", style: {
                        animationDelay: `${index * 100}ms`,
                            ...
                            textAlign: "left",
                                    ...
                                    }, children: (0, jsx_runtime_1.jsx)(Img_js_1.Img, { alt: provider.name, client: client, height: index_js_1.iconSize.md, src: provider.iconUri, width: index_js_1.iconSize.md }) }), (0, jsx_runtime_1.jsx)(basic_js_1.Container, { flex: "column", gap: "3xs", style: { flex: 1 }, children: (0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "primaryText", size: "md", style: { fontWeight: 600 }, children: provider.name }) }), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "column", gap: "3xs", style: { alignItems: "flex-end" }, children: [(0, jsx_runtime_1.jsxs)(text_js_1.Text, { color: "primaryText", size: "sm", style: { fontWeight: 500 }, children: ["$", quote.currencyAmount.toLocaleString(undefined, {
                                                    maximumFractionDigits: 2,
                                                    minimumFractionDigits: 2,
                                                }), " ", quote.currency] }), (0, jsx_runtime_1.jsxs)(text_js_1.Text, { color: "secondaryText", size: "xs", children: [(0, units_js_1.toTokens)(quote.destinationAmount, quote.destinationToken.decimals), " ", quote.destinationToken.symbol] })] })] }) }) }, provider.id));
