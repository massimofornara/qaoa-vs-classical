...
function ViewAssets(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { animate: "fadein", style: {
            minHeight: "300px",
        }, children: [(0, jsx_runtime_1.jsx)(basic_js_1.Container, { p: "lg", children: (0, jsx_runtime_1.jsx)(basic_js_1.ModalHeader, { onBack: props.onBack, title: connectLocale.viewFunds.viewAssets }) }), (0, jsx_runtime_1.jsx)(basic_js_1.Line, {}), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { px: "lg", scrollY: true, style: {
                    minHeight: "330px",
                }, children: [(0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "md" }), (0, jsx_runtime_1.jsx)(Tabs_js_1.default, { onSelect: setActiveTab, options: options, selected: activeTab, children: (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { scrollY: true, style: {
                                maxHeight: "300px",
                            }, children: [activeTab === "Tokens" && ((0, jsx_runtime_1.jsx)(ViewTokens_js_1.ViewTokensContent, { client: props.client, connectLocale: connectLocale, supportedTokens: props.supportedTokens })), activeTab === "NFTs" && ((0, jsx_runtime_1.jsx)(ViewNFTs_js_1.ViewNFTsContent, { client: props.client, connectLocale: connectLocale, supportedNFTs: props.supportedNFTs, theme: props.theme }))] }) }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "lg" })] })] }));
}
