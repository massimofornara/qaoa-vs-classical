 ...
 */
function useTransactionDetails({ transaction, client, }) {
    ...
    return (0, react_query_1.useQuery)({
        ...
        queryFn: async () => {
            ...
            const [tokenInfo, gasCostWei] = await Promise.all([
                (0, get_token_js_1.getToken)(client, erc20Value ? erc20Value.tokenAddress : addresses_js_1.NATIVE_TOKEN_ADDRESS, transaction.chain.id).catch(() => null),
            ...
            return {
                ...
                usdValueDisplay: usdValue
                    ? (0, formatTokenBalance_js_1.formatCurrencyAmount)("USD", usdValue)
                    : null,
            };
        },
        queryKey: [
