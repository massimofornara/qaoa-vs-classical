...
const AutoConnect_js_1 = require("../../web/ui/AutoConnect/AutoConnect.js");
...
function PayEmbed(props) {
    ...
    const siweAuth = (0, useSiweAuth_js_1.useSiweAuth)(activeWallet, activeAccount, props.connectOptions?.auth);
    ...
    if (props.payOptions?.mode === "fund_wallet" &&
        ...
        return ((0, jsx_runtime_1.jsx)(BuyWidget_js_1.BuyWidget, { amount: props.payOptions.prefillBuy.amount || "0.01", chain: props.payOptions.prefillBuy.chain, client: props.client, theme: theme, title: metadata?.name || "Buy", tokenAddress: props.payOptions.prefillBuy.token?.address }));
    }
    if (props.payOptions?.mode === "direct_payment") {
        return ((0, jsx_runtime_1.jsx)(CheckoutWidget_js_1.CheckoutWidget, { amount: props.payOptions.paymentInfo.amount, chain: props.payOptions.paymentInfo.chain, client: props.client, description: metadata?.description, image: metadata?.image, name: metadata?.name || "Checkout", seller: props.payOptions.paymentInfo.sellerAddress, theme: theme, tokenAddress: props.payOptions.paymentInfo.token?.address }));
    }
    if (props.payOptions?.mode === "transaction") {
        return ((0, jsx_runtime_1.jsx)(TransactionWidget_js_1.TransactionWidget, { client: props.client, description: metadata?.description, image: metadata?.image, theme: theme, title: metadata?.name, transaction: props.payOptions.transaction }));
    }
    if (!localeQuery.data) {
        ...
        content = ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(AutoConnect_js_1.AutoConnect, { client: props.client, siweAuth: siweAuth }), screen === "buy" && ((0, jsx_runtime_1.jsx)(BuyScreen_js_1.default, { client: props.client, connectLocale: localeQuery.data, connectOptions: props.connectOptions, hiddenWallets: props.hiddenWallets, isEmbed: true, onBack: undefined, onDone: () => {
                        if (props.payOptions?.mode === "transaction") {
                            setScreen("execute-tx");
                        }
                    }, paymentLinkId: props.paymentLinkId, payOptions: props.payOptions || {
                        mode: "fund_wallet",
                    }, supportedTokens: props.supportedTokens, theme: theme, title: metadata?.name || "Buy" }))] }));
    }
