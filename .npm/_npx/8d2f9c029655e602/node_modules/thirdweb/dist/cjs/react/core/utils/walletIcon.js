...
exports.useWalletIcon = useWalletIcon;
exports.fetchWalletImage = fetchWalletImage;
...
function useWalletIcon(props) {
    ...
    const imageQuery = (0, react_query_1.useQuery)({
...
async function fetchWalletImage(props) {
    ...
    return (0, getWalletInfo_js_1.getWalletInfo)(props.id, true);
}
