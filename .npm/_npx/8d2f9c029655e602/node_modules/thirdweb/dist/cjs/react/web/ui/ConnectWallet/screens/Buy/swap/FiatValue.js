...
function FiatValue(props) {
    ...
    return cryptoToFiatQuery.data?.result ? ((0, jsx_runtime_1.jsxs)(text_js_1.Text, { ...props, children: ["$", Number((0, formatNumber_js_1.formatNumber)(cryptoToFiatQuery.data.result, 2).toFixed(2)).toLocaleString(undefined, {
