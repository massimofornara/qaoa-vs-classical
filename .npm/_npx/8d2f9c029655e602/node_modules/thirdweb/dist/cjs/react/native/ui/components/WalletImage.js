...
const WalletImage = (props) => {
    ...
    return ((0, jsx_runtime_1.jsx)(RNImage_js_1.RNImage, { color: props.theme.colors.accentButtonBg, data: data, size: size, theme: props.theme }));
};
