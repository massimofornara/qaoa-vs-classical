...
exports.ReceiveFunds = ReceiveFunds;
...
function ReceiveFunds(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { p: "lg", children: [(0, jsx_runtime_1.jsx)(basic_js_1.ModalHeader, { onBack: props.onBack, title: locale.title }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "xl" }), (0, jsx_runtime_1.jsx)(basic_js_1.Container, { center: "x", flex: "row", children: (0, jsx_runtime_1.jsx)(QRCode_js_1.QRCode, { QRIcon: props.walletId && ((0, jsx_runtime_1.jsx)(WalletImage_js_1.WalletImage, { client: client, id: props.walletId, size: index_js_1.iconSize.xxl })), qrCodeUri: address, size: 310 }) }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "xl" }), (0, jsx_runtime_1.jsxs)(WalletAddressContainer, { onClick: onCopy, children: [(0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "primaryText", size: "md", children: (0, addresses_js_1.shortenString)(address || "") }), (0, jsx_runtime_1.jsx)(CopyIcon_js_1.CopyIcon, { hasCopied: hasCopied, text: address || "", tip: "Copy address" })] }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "lg" }), (0, jsx_runtime_1.jsx)(text_js_1.Text, { balance: true, center: true, className: "receive_fund_screen_instruction", multiline: true, children: locale.instruction })] }));
}
