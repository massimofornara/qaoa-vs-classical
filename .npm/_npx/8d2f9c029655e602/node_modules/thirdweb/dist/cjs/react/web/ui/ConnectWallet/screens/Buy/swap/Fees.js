...
function FiatFees(props) {
    return ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "column", gap: "xs", children: [(0, jsx_runtime_1.jsxs)("div", { style: {
                ...
                }, children: [(0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "secondaryText", inline: true, children: "Amount" }), (0, jsx_runtime_1.jsxs)(text_js_1.Text, { color: "primaryText", inline: true, children: [(0, formatNumber_js_1.formatNumber)(Number(props.quote.fromCurrency.amount), 2), " ", props.quote.fromCurrency.currencySymbol] })] }), props.quote.processingFees.map((fee, i) => {
                const feeAmount = (0, formatNumber_js_1.formatNumber)(Number(fee.amount), 6);
                return ((0, jsx_runtime_1.jsxs)("div", { style: {
                        display: "flex",
                        justifyContent: "space-between",
                    }, children: [(0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "secondaryText", inline: true, children: fee.feeType === "NETWORK" ? "Network Fee" : "Processing Fee" }), (0, jsx_runtime_1.jsxs)(text_js_1.Text, { color: "primaryText", inline: true, children: [feeAmount === 0 ? "~" : "", " ", feeAmount, " ", fee.currencySymbol] })] }, i));
                    ...
                    display: "flex",
                    justifyContent: "space-between",
                }, children: [(0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "secondaryText", inline: true, children: "Total" }), (0, jsx_runtime_1.jsxs)(text_js_1.Text, { color: "primaryText", inline: true, children: [(0, formatNumber_js_1.formatNumber)(Number(props.quote.fromCurrencyWithFees.amount), 6), " ", props.quote.fromCurrencyWithFees.currencySymbol] })] })] }));
}
