...
function DetailsModal(props) {
    ...
    let content = ((0, jsx_runtime_1.jsxs)("div", { className: `${TW_CONNECTED_WALLET}__default_modal_screen`, children: [(0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "xs" }), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { center: "y", flex: "row", gap: "sm", px: "lg", style: {
                    ...
                    paddingTop: index_js_1.spacing.lg,
                                ...
                                gap: index_js_1.spacing.xs,
                                        ...
                                        gap: index_js_1.spacing.xs,
                                        padding: index_js_1.spacing.sm,
                                    }, variant: "outline", children: [(0, jsx_runtime_1.jsx)(basic_js_1.Container, { center: "both", color: "secondaryText", flex: "row", children: (0, jsx_runtime_1.jsx)(react_icons_1.PinBottomIcon, { height: index_js_1.iconSize.sm, width: index_js_1.iconSize.sm }) }), locale.receive] })), !hideBuyFunds && ((0, jsx_runtime_1.jsxs)(buttons_js_1.Button, { onClick: () => {
    ...
    // thirdweb pay
        ...
        content = ((0, jsx_runtime_1.jsx)(LazyBuyScreen_js_1.LazyBuyScreen, { client: client, connectLocale: locale, connectOptions: undefined, hiddenWallets: props.detailsModal?.hiddenWallets, isEmbed: false, onBack: () => setScreen("main"), onDone: closeModal, payOptions: props.detailsModal?.payOptions || {
                mode: "fund_wallet",
