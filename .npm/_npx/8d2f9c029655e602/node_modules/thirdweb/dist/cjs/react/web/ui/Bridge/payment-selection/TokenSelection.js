...
function PaymentMethodTokenRow({ paymentMethod, destinationToken, destinationAmount, client, onPaymentMethodSelected, }) {
    ...
    return ((0, jsx_runtime_1.jsx)(buttons_js_1.Button, { disabled: !hasEnoughBalance, fullWidth: true, onClick: () => onPaymentMethodSelected(paymentMethod), style: {
            ...
            textAlign: "left",
                        ...
                        maxWidth: "50%",
                    }, token: paymentMethod.originToken }), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "column", gap: "3xs", style: { alignItems: "flex-end", flex: 1 }, children: [quoteLoading ? ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { height: "16px", width: "80px" }), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "row", gap: "3xs", children: [(0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { height: "12px", width: "50px" }), (0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { height: "12px", width: "40px" })] })] })) : quoteError ? ((0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "danger", size: "sm", style: { fontWeight: 600 }, children: "Quote failed" })) : displayOriginAmount ? ((0, jsx_runtime_1.jsxs)(text_js_1.Text, { color: "primaryText", size: "sm", style: { fontWeight: 600, textWrap: "nowrap" }, children: [(0, formatTokenBalance_js_1.formatTokenAmount)(displayOriginAmount, paymentMethod.originToken.decimals), " ", paymentMethod.originToken.symbol] })) : ("--.--"), !quoteLoading && ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "row", gap: "3xs", children: [(0, jsx_runtime_1.jsxs)(text_js_1.Text, { color: "secondaryText", size: "xs", children: ["Balance:", " "] }), (0, jsx_runtime_1.jsx)(text_js_1.Text, { color: !quoteLoading
                                        ? hasEnoughBalance
                                            ? "success"
                                            : "danger"
                                        : "secondaryText", size: "xs", children: (0, formatTokenBalance_js_1.formatTokenAmount)(paymentMethod.balance, paymentMethod.originToken.decimals) })] }))] })] }) }, `${paymentMethod.originToken.address}-${paymentMethod.originToken.chainId}`));
}
function TokenSelection({ paymentMethods, paymentMethodsLoading, client, onPaymentMethodSelected, onBack, destinationToken, destinationAmount, }) {
    ...
    if (paymentMethodsLoading) {
        return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "primaryText", size: "md", children: "Loading your tokens" }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "sm" }), (0, jsx_runtime_1.jsx)(basic_js_1.Container, { flex: "column", gap: "sm", children: [1, 2, 3].map((i) => ((0, jsx_runtime_1.jsx)(basic_js_1.Container, { style: {
                            backgroundColor: theme.colors.tertiaryBg,
                            border: `1px solid ${theme.colors.borderColor}`,
                            borderRadius: index_js_1.radius.md,
                            padding: `${index_js_1.spacing.sm} ${index_js_1.spacing.md}`,
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "primaryText", size: "md", children: "Select payment token" }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "sm" }), (0, jsx_runtime_1.jsx)(basic_js_1.Container, { flex: "column", gap: "sm", style: {
                    maxHeight: "400px",
                    overflowY: "auto",
                    scrollbarWidth: "none",
                }, children: paymentMethods
                    .filter((method) => method.type === "wallet")
                    .map((method) => ((0, jsx_runtime_1.jsx)(PaymentMethodTokenRow, { client: client, destinationAmount: destinationAmount, destinationToken: destinationToken, onPaymentMethodSelected: onPaymentMethodSelected, paymentMethod: method }, `${method.originToken.address}-${method.originToken.chainId}`))) })] }));
}
