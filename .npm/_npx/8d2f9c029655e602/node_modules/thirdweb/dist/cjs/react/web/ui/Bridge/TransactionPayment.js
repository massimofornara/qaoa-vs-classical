...
function TransactionPayment({ uiOptions, client, onContinue, connectOptions, }) {
    ...
    return ((0, jsx_runtime_1.jsxs)(WithHeader_js_1.WithHeader, { client: client, defaultTitle: "Transaction", uiOptions: uiOptions, children: [(0, jsx_runtime_1.jsxs)(basic_js_1.Container, { center: "y", flex: "row", gap: "3xs", style: {
                    ...
                    label: buttonLabel,
                }, theme: theme, ...connectOptions })), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "md" }), (0, jsx_runtime_1.jsx)(PoweredByTW_js_1.PoweredByThirdweb, {}), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "lg" })] }));
}
