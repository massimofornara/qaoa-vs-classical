...
exports.LargeAmountLight = exports.LargeAmount = exports.USDCTokenLight = exports.USDCToken = exports.WithInitialAmountLight = exports.WithInitialAmount = exports.Dark = exports.Light = void 0;
const jsx_runtime_1 = require("react/jsx-runtime");
const FundWallet_js_1 = require("../../react/web/ui/Bridge/FundWallet.js");
const utils_js_1 = require("../utils.js");
const fixtures_js_1 = require("./fixtures.js");
// Wrapper component to provide theme context
const FundWalletWithTheme = (props) => {
    const { theme, ...componentProps } = props;
    return ((0, jsx_runtime_1.jsx)(utils_js_1.ModalThemeWrapper, { theme: theme, children: (0, jsx_runtime_1.jsx)(FundWallet_js_1.FundWallet, { ...componentProps }) }));
};
const meta = {
    args: {
        ...
        receiverAddress: fixtures_js_1.RECEIVER_ADDRESSES.primary,
        theme: "dark",
...
exports.WithInitialAmount = {
    args: {
        receiverAddress: fixtures_js_1.RECEIVER_ADDRESSES.secondary,
        theme: "dark",
        uiOptions: fixtures_js_1.FUND_WALLET_UI_OPTIONS.ethWithAmount,
    },
    parameters: {
        backgrounds: { default: "dark" },
        docs: {
...
exports.WithInitialAmountLight = {
    args: {
        receiverAddress: fixtures_js_1.RECEIVER_ADDRESSES.secondary,
        theme: "light",
        uiOptions: fixtures_js_1.FUND_WALLET_UI_OPTIONS.ethWithAmount,
...
exports.USDCToken = {
    args: {
        theme: "dark",
        uiOptions: fixtures_js_1.FUND_WALLET_UI_OPTIONS.usdcDefault,
    },
    parameters: {
        backgrounds: { default: "dark" },
        docs: {
...
exports.LargeAmount = {
    args: {
        theme: "dark",
        uiOptions: fixtures_js_1.FUND_WALLET_UI_OPTIONS.uniLarge,
    },
    parameters: {
        backgrounds: { default: "dark" },
        docs: {
