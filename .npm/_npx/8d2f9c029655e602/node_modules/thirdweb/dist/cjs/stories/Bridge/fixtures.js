...
exports.TRANSACTION_UI_OPTIONS = exports.DIRECT_PAYMENT_UI_OPTIONS = exports.FUND_WALLET_UI_OPTIONS = exports.RECEIVER_ADDRESSES = exports.simpleBuyRequest = exports.complexBuyQuote = exports.buyWithApprovalQuote = exports.longTextBuyQuote = exports.simpleBuyQuote = exports.onrampWithSwapsQuote = exports.simpleOnrampQuote = exports.STORY_MOCK_WALLET = exports.UNI = exports.USDC = exports.ETH = void 0;
const viem_1 = require("viem");
const base_js_1 = require("../../chains/chain-definitions/base.js");
const base_sepolia_js_1 = require("../../chains/chain-definitions/base-sepolia.js");
const polygon_js_1 = require("../../chains/chain-definitions/polygon.js");
const utils_js_1 = require("../../chains/utils.js");
const addresses_js_1 = require("../../constants/addresses.js");
const contract_js_1 = require("../../contract/contract.js");
const claimTo_js_1 = require("../../extensions/erc20/drops/write/claimTo.js");
const transfer_js_1 = require("../../extensions/erc20/write/transfer.js");
const defaultTokens_js_1 = require("../../react/core/utils/defaultTokens.js");
...
exports.USDC = {
    address: (0, defaultTokens_js_1.getDefaultToken)(base_js_1.base, "USDC")?.address ?? "",
    chainId: base_js_1.base.id,
    decimals: 6,
...
const createStoryMockWallet = () => {
    ...
    return {
        ...
        getChain: async () => (0, utils_js_1.defineChain)(1),
        getConfig: () => ({}),
        id: "inApp",
        subscribe: () => () => { },
        switchChain: async () => { },
...
exports.STORY_MOCK_WALLET = createStoryMockWallet();
// Simple onramp quote with no extra steps
exports.simpleOnrampQuote = JSON.parse((0, viem_1.stringify)({
    currency: "USD",
    currencyAmount: 50.0,
...
const ethTransferTransaction = (0, prepare_transaction_js_1.prepareTransaction)({
    chain: base_sepolia_js_1.baseSepolia,
    client: utils_js_2.storyClient,
...
const erc20Transaction = (0, transfer_js_1.transfer)({
    amount: 100,
...
// claimTo on Polygon
const contractInteractionTransaction = (0, claimTo_js_1.claimTo)({
    contract: (0, contract_js_1.getContract)({
...
exports.FUND_WALLET_UI_OPTIONS = {
    ethDefault: {
        destinationToken: exports.ETH,
        metadata: {
    ...
    usdcDefault: {
        destinationToken: exports.USDC,
        initialAmount: "5",
        mode: "fund_wallet",
    },
};
// UI Options for DirectPayment mode
exports.DIRECT_PAYMENT_UI_OPTIONS = {
    concertTicket: {
        metadata: {
